...
public class Logic {
    // Fumlah tiles yang ada pada game
    private int nbTiles;        
    ...
    public boolean isSolvable(GUISlidingNumber pg){
    ...
    // Method yang memeriksa apakah semua tiles berada di posisi seharusnya agar game selesai
